...
$stmt = $db->prepare('SELECT * FROM Object WHERE id limit 18, 9;');
$stmt->execute();
...
<h2><a href="?p=gallery2"><img alt="previmage" src="img/prev.png"></a> Sida 3 av 4 <a href="?p=gallery4"><img alt="nextimage" src="img/next.png"></a></h2>
